...
export interface SignInSecurityKeyPasswordlessState extends SignInSecurityKeyPasswordlessHandlerResult, ActionLoadingState {
}
export declare const signInEmailSecurityKeyPromise: (interpreter: import("xstate").Interpreter<import("..").AuthContext, any, {
    type: "SESSION_UPDATE";
    data: {
