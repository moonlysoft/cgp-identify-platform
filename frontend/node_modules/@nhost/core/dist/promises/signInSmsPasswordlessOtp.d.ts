...
export interface SignInSmsPasswordlessOtpState extends SignInSmsPasswordlessOtpHandlerResult, ActionLoadingState {
}
export declare const signInSmsPasswordlessOtpPromise: (interpreter: import("xstate").Interpreter<import("..").AuthContext, any, {
    type: "SESSION_UPDATE";
    data: {
