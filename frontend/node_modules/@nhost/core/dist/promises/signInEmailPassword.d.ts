...
export interface SignInEmailPasswordState extends SignInEmailPasswordHandlerResult, ActionLoadingState {
}
export declare const signInEmailPasswordPromise: (interpreter: import("xstate").Interpreter<import("..").AuthContext, any, {
    type: "SESSION_UPDATE";
    data: {
