export interface Typegen0 {
    ...
    eventsCausingDelays: {};
    matchesStates: 'idle' | 'idle.initial' | 'idle.error' | 'generating' | 'generated' | 'generated.idle' | 'generated.idle.idle' | 'generated.idle.error' | 'generated.activating' | 'generated.activated' | {
        idle?: 'initial' | 'error';
        generated?: 'idle' | 'activating' | 'activated' | {
            idle?: 'idle' | 'error';
        };
    };
    tags: never;
