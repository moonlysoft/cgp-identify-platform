...
export declare const encodeQueryParameters: (baseUrl: string, parameters?: Record<string, unknown> | undefined) => string;
/**
 ...
 * @returns
 */
export declare const rewriteRedirectTo: <T extends RedirectOption>(clientUrl?: string | undefined, options?: T | undefined) => (Omit<T, "redirectTo"> & {
