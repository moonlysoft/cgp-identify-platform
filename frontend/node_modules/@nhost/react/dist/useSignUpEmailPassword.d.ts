import { SignUpEmailPasswordState, SignUpOptions } from '@nhost/core';
declare type SignUpEmailPasswordHandlerResult = Omit<SignUpEmailPasswordState, 'isLoading'>;
interface SignUpEmailPasswordHandler {
    ...
    /** @deprecated */
    (email?: unknown, password?: string, options?: SignUpOptions): Promise<SignUpEmailPasswordHandlerResult>;
}
